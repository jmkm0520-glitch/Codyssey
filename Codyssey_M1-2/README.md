...
![매출 요약, 데이터 관리, AI 채팅이 실제 데이터로 동작하는 화면](screenshots/dashboard-and-chat.png)

배포된 화면([`https://codyssey-one.vercel.app`](https://codyssey-one.vercel.app))에서 실제로 캡처한 화면입니다.
